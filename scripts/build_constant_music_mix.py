...
# Approved Claude 12-block music map for video_001.
# Constant background only: -18 dB, no ducking, no dramatic gain changes.
BLOCKS = [
...
def main():
    ...
    for idx, (block_no, start_shot, end_shot, filename, offset) in enumerate(BLOCKS, start=1):
        ...
        # Only short click-free fades at track boundaries; body gain remains fixed at -18 dB.
        ...
        filters.append(
            ...
            f'volume={GAIN:.9f},adelay={delay_ms}|{delay_ms}[{label}]'
        )
    ...
    print(f'MUSIC MIX OK: 12 blocks, fixed -18 dB, ducking OFF, output={OUT}')
